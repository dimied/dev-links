...
## Web terminology
- [Cross-Site-Tracing](https://de.wikipedia.org/wiki/Cross-Site-Tracing)
...
- [breakingsecurity](https://breakingsecurity.net/)
- [Cybereason](https://www.cybereason.com/de/)
- [DDOS-Guard](https://ddos-guard.net/)
- [Cybrary](https://www.cybrary.it/)
- [Illumio](https://www.illumio.com/)
- [Maltego](https://www.maltego.com/)
- [Maxmind](https://www.maxmind.com/en/home)
- [OpenNMS](https://de.wikipedia.org/wiki/OpenNMS)
- [Security Onion Solutions](https://securityonionsolutions.com/)
- [SONICWALL](https://www.sonicwall.com/)
- [Tamosoft](https://www.tamos.com/)
- [Team Cymru](https://www.team-cymru.com/)
- [Trend Vision One](https://www.trendmicro.com/de_de/business.html)
...
- [DrownAttack](https://drownattack.com/)
...
- [Redsiege](https://redsiege.com/tools/)
...
## Communication
- [Disaspora](https://diasporafoundation.org/)
- [Prism Break](https://prism-break.org/de/)
...
- [infisical](https://infisical.com/)
  - [Infisical (git)](https://github.com/Infisical/infisical)
...
## Encryption
- [Xecrets Ez](https://www.axantum.com/file-encryption)
- [VeryCrypt](https://veracrypt.io/en/Home.html)
-
-
...
- [JDBG](https://github.com/roger1337/JDBG)
-
-
...
## Platforms
- [CISA]()
  - https://www.cisa.gov/resources-tools/resources/cisa-insights-implement-cybersecurity-measures-now-protect-against
  - https://www.cisa.gov/known-exploited-vulnerabilities-catalog
- [MISP](https://en.wikipedia.org/wiki/MISP_Threat_Sharing)
  - [MISP](https://www.misp-project.org/)
- [OSSEC](https://www.ossec.net/)
- [Yeti](https://www.helpnetsecurity.com/2023/10/12/yeti-threat-intelligence/)
...
- https://medium.com/@dev_tips/zero-trust-one-router-hardening-your-home-lab-like-a-cyber-fortress-567fc3bdf880
- https://developer.mozilla.org/de/docs/Web/Security/Defenses/Subresource_Integrity
...
-
- [How to Use Port Knocking on Linux](https://www.howtogeek.com/442733/how-to-use-port-knocking-on-linux-and-why-you-shouldnt/)
...
- https://owasp.org/www-community/controls/Certificate_and_Public_Key_Pinning#.Net
- https://security.stackexchange.com/questions/94390/whats-the-purpose-of-dh-parameters
-

## Articles (Cookies)
- [Web security: hardening HTTP cookies](https://odino.org/security-hardening-http-cookies/)
...
- [Stateful REST API Fuzzing with RESTler](https://www.code-intelligence.com/blog/stateful-rest-api-fuzzing)
- [How to Prevent DDoS Attacks: 5 Steps for DDoS Prevention](https://www.esecurityplanet.com/networks/how-to-prevent-ddos-attacks/)

...
- [Minimal web server using netcat](https://stackoverflow.com/questions/16640054/minimal-web-server-using-netcat)
- [What is Port Knocking ?](https://help.ubuntu.com/community/PortKnocking)
...
- [Terraform: Using Local Modules to Create a Two-Tier Architecture](https://medium.com/nerd-for-tech/terraform-using-local-modules-to-create-a-two-tier-architecture-d4e9c2f24b47)
- [SRE vs. DevOps — a False Distinction?](https://devops.com/sre-vs-devops-false-distinction/)
- [SRE Books](https://sre.google/books/)
- [What are Proxy Servers?](https://medium.com/@kyledeguzmanx/what-are-proxy-servers-4df13d91b676)
- [Event-Driven Architectures vs. Event-Based Compute in Serverless Applications](https://www.alexdebrie.com/posts/event-driven-vs-event-based/)
- https://thenewstack.io/how-to-create-and-use-container-volumes-within-portainer/
...
- https://thenewstack.io/container-security-manage-secrets-with-portainer/
- https://thenewstack.io/the-real-time-data-mesh-and-its-place-in-modern-it-stacks/

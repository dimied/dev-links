...
- [Pelikan cache](https://pelikan.io/)
...
### Database
- [Prometheus and Grafana for MySQL](https://help.scalegrid.io/docs/mysql-connecting-to-prometheus-and-grafana)

## AMD, Intel
- [AMD](https://www.amd.com/en/developer.html)
- [Advanced Vector Extensions](https://en.wikipedia.org/wiki/Advanced_Vector_Extensions)
- [sandpile](https://sandpile.org/)
- [x86 instruction listings](https://en.wikipedia.org/wiki/X86_instruction_listings#Intel_SHA_instructions)
...
## HPC
- [hpcuniversity](http://hpcuniversity.org/)
...
- https://vite.dev/guide/features.html#:~:text=By%20default%2C%20Vite%20uses%20esbuild%20to%20minify%20CSS
...
- [Lazy Loading Video Based on Connection Speed](https://ben.robertson.is/front-end/lazy-load-connection-speed/)
...
- [Core Web Vitals & Boosting Your Website’s Speed!](https://javascript.plainenglish.io/core-web-vitals-boosting-your-websites-speed-a2ea4d595f0d)
...
- [JavaScript performance optimization](https://developer.mozilla.org/en-US/docs/Learn_web_development/Extensions/Performance/JavaScript)
- [Cumulative Layout Shift (CLS)](https://web.dev/articles/cls?hl=de)
...
- [Hacking Web Performance](https://firt.dev/hacking-web-performance/)
- [Introduction to Lighthouse](https://developer.chrome.com/docs/lighthouse/overview/)
- [Front-End Performance Checklist 2021](https://www.smashingmagazine.com/2021/01/front-end-performance-2021-free-pdf-checklist/)
- [Avoid Using Cache in Your Application or Do It Right](https://levelup.gitconnected.com/avoid-using-cache-in-your-application-or-do-it-right-9650214797bc)
- [Load Balancing: Become a stateless pirate in a Javascript world](https://medium.com/@ObjectiveCopley/become-a-stateless-pirate-in-a-javascript-world-d9a4eaee4bb2)
- [Cache Website Assets in “Offline Mode”](https://javascript.plainenglish.io/cache-website-assets-in-offline-mode-fb843c58feef)
...
- [System design paradigm: Caching](https://luanjunyi.medium.com/system-design-paradigm-caching-e57a25ab2f0a)
...
- [Rasend schnelle Ladezeiten dank Prefetching, Preloading und Prerendering](https://de.ryte.com/magazine/rasend-schnelle-ladezeiten-dank-prefetching-preloading-und-prerendering/)
- [Schnelle und einfache Anwendungen mit Save-Data bereitstellen](https://web.dev/articles/optimizing-content-efficiency-save-data?hl=de)
- [Kritischer Rendering-Pfad](https://web.dev/articles/critical-rendering-path?hl=de)
- [Website Performance checklist](https://hackernoon.com/website-performance-checklist-bfeeb2cd362d)
- [Erste Schritte zur Verwendung des Anwendungscaches](https://web.dev/articles/appcache-beginner?hl=de)
...
- [How to boost your front-end application’s performance](https://www.freecodecamp.org/news/how-to-boost-your-front-end-applications-performance-72ce872b08c/)
- [Messen von I/O Performance](https://www.thomas-krenn.com/de/wiki/Messen_von_I/O_Performance)
- [The C10K problem](https://www.kegel.com/c10k.html)
- [Website mit PageSpeed-Tools analysieren und optimieren](https://developers.google.com/speed?hl=de-DE)
- https://github.com/vitorlofonseca/demo-web-performance-monitoring
- [Node.js Performance Monitoring with Prometheus](https://blog.risingstack.com/node-js-performance-monitoring-with-prometheus/)
- [Frontend Monitoring with Prometheus](https://nedmcclain.medium.com/frontend-monitoring-with-prometheus-38f798406125)
- [Sofortiges Laden mit dem PRPL-Muster anwenden](https://web.dev/articles/apply-instant-loading-with-prpl?hl=de)
- [Frontend Performance](https://roadmap.sh/frontend-performance-best-practices)
- [Kurze Ladezeiten](https://web.dev/explore/fast?hl=de#optimize-your-images)
- [Lazy Loading für Bilder auf Browserebene für das Web](https://web.dev/articles/browser-level-image-lazy-loading?hl=de)
- [Permanentspeicher](https://web.dev/articles/persistent-storage?hl=de)

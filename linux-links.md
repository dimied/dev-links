...
## Videos
- https://www.youtube.com/watch?v=TYxPLEmbCuk
- https://www.youtube.com/watch?v=bSAgQqa49nM
...
- [MOC - music on console](https://moc.daper.net/node/692)
- [xorriso](https://www.gnu.org/software/xorriso/)
- https://www.thegeekstuff.com/2010/06/lzma-better-compression-than-bzip2-on-unix-linux/#more-4511
- https://www.cyberciti.biz/tips/my-10-unix-command-line-mistakes.html
- cal
  - https://www.hscripts.com/de/tutorials/linux-commands/cal.html
- [OpenVZ](https://de.wikipedia.org/wiki/OpenVZ)
- [PeaZip](https://wiki.ubuntuusers.de/PeaZip/)
- [Zattoo](https://www.ubuntugeek.com/zattoo-watch-online-tv-for-free.html)
- [PulseAudio](https://www.freedesktop.org/wiki/Software/PulseAudio/FAQ/)
...
- https://forums.justlinux.com/showthread.php?149828-Hidden-partitions-tips
- [Rsync](https://www.yolinux.com/TUTORIALS/Rsync.html)
- [Rsyncmirror](https://help.ubuntu.com/community/Rsyncmirror)
- [Synchronizing folders with rsync](https://en.jveweb.net/archives/2010/11/synchronizing-folders-with-rsync.html)
- [Using rsync to Sync Local and Remote Systems](https://www.liquidweb.com/help-docs/server-administration/linux/file-management/using-rsync-to-sync-local-and-remote-systems/)
- https://www.cyberciti.biz/faq/cpu-usage-limiter-for-linux/
- https://www.cyberciti.biz/tips/top-linux-monitoring-tools.html
- https://www.cyberciti.biz/faq/ubuntu-mount-iso-image/
- https://superuser.com/questions/401972/how-to-extract-files-from-iso-on-linux
- [Overview of RAMFS and TMPFS on Linux](https://www.thegeekstuff.com/2008/11/overview-of-ramfs-and-tmpfs-on-linux/)
- [Storing Files/Directories In Memory With tmpfs](https://www.howtoforge.com/storing-files-directories-in-memory-with-tmpfs)
- udev
  - https://www.google.com/search?client=ubuntu&channel=fs&q=udev%3A+starting+&ie=utf-8&oe=utf-8#pq=udev%3A+starting+&hl=de&cp=15&gs_id=4&xhr=t&q=udev+starting+version+151&pf=p&sclient=psy-ab&client=ubuntu&hs=DXj&channel=fs&source=hp&pbx=1&oq=udev:+starting+&aq=0L&aqi=g-L1g-vL3&aql=&gs_sm=&gs_upl=&bav=on.2,or.r_gc.r_pw.,cf.osb&fp=57c6a97b79542dda&biw=1229&bih=485
- https://wiki.ubuntuusers.de/Defragmentierung/
- [Setting Up Swap Space](https://tldp.org/HOWTO/Partition/setting_up_swap.html)
- [How to Clone Your Linux Hard Drive: 5 Methods](https://www.makeuseof.com/tag/2-methods-to-clone-your-linux-hard-drive/)
- [RAM-Disk erstellen](https://wiki.ubuntuusers.de/RAM-Disk_erstellen/)
...
## FTP
- https://www.raphael.li/blog/2015/03/synchronize-ftp/
...
## Security
- https://askmeaboutlinux.com/2013/01/27/use-wuala-to-store-encrypted-data/
...
- https://www.linuxquestions.org/questions/programming-9/file-size-using-bash-script-410766/
- https://stackoverflow.com/questions/3872323/bash-make-the-first-letter-uppercase
- https://www.linuxquestions.org/questions/programming-9/bash-change-first-character-to-upper-case-570445/
- https://www.linuxquestions.org/questions/linux-general-1/how-to-determine-if-a-string-contains-some-characters-682462/
- https://stackoverflow.com/questions/8063228/check-if-a-variable-exists-in-a-list-in-bash
- [Floating Point Math in Bash](https://www.linuxjournal.com/content/floating-point-math-bash)
- [Copy folder recursively, excluding some folders](https://stackoverflow.com/questions/2193584/copy-folder-recursively-excluding-some-folders)
- [Manipulating Strings](http://www.faqs.org/docs/abs/HTML/string-manipulation.html)
- [Using case statements](https://tldp.org/LDP/Bash-Beginners-Guide/html/sect_07_03.html)
...
- https://www.tuxfiles.org/linuxhelp/wildcards.html
...
## Tuning
- https://wiki.ubuntuusers.de/Tuning/


## Articles
- [Nach Dateien mit bestimmten Inhalt suchen](https://www.bimminger.at/content/bereich/tips_linux/tipp_linux_suche_in_datei_bestimmter_inhalt.html)
- [Linux: Nach Text in Dateien suchen – find text in files](https://www.giga.de/extra/linux/tipps/linux-find-text-in-files-so-koennt-ihr-nach-text-in-dateien-suchen/)
...
- https://www.pcwelt.de/article/1147571/linux-geraete_nach_wunsch_upgraden-anleitung.html
- https://superuser.com/questions/145332/slowing-down-cpu-speed
- https://superuser.com/questions/166317/linux-compare-directory-structure-without-comparing-files
- https://www.cyberciti.biz/faq/linux-how-to-determine-find-out-file-system-type/
- https://www.computerbase.de/forum/threads/openvpn-config-datei-aendern-damit-kein-username-password-abgefragt-wird.1015440/
...
- https://fabian-martin.name/blog/2011/05/linux-root-passwort-zurucksetzen/#more-72
- https://www.linux-club.de/forum/t/wie-usb-stick-formatieren.59075/
- https://neaptide.org/projects/fdupe/
